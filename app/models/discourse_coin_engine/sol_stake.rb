...
# v0.12.3 - On-chain SOL staking. Distinct from the Phase 2 in-platform $RENO
# Stake class (in bounty.rb) which lives at table coin_engine_stakes.
# This model lives at table coin_engine_sol_stakes.

module DiscourseCoinEngine
  class SolStake < ::ActiveRecord::Base
    self.table_name = 'coin_engine_sol_stakes'
