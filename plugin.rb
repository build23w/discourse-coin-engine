...
after_initialize do
  ...
  # CE-005 (2026-06-10): the registration that used to live here ran BEFORE the
  # mailer file is loaded (see the `load .../app/mailers/...` line further down),
  # so it raised NameError on every boot and the rescue swallowed it -- mailers
  # stayed MissingTemplate. The mailer class now registers its own view path in
  # app/mailers/discourse_coin_engine_mailer.rb (no load-order dependency).
  ...
  load File.expand_path('../lib/discourse_coin_engine/stake2earn.rb', __FILE__)
  load File.expand_path('../app/controllers/discourse_coin_engine/stake2earn_controller.rb', __FILE__)
  load File.expand_path('../app/controllers/discourse_coin_engine/admin_stake2earn_controller.rb', __FILE__)
  load File.expand_path('../app/jobs/scheduled/discourse_coin_engine_staker_sync.rb', __FILE__)
  load File.expand_path('../app/jobs/scheduled/discourse_coin_engine_staker_boost.rb', __FILE__)
  ...
  Discourse::Application.routes.append do
    ...
    get  '/coin-engine/stake2earn/status.json'   => 'discourse_coin_engine/stake2earn#status'
    get  '/coin-engine/stake2earn/treasury.json' => 'discourse_coin_engine/stake2earn#treasury'
    get  '/admin/coin-engine/stake2earn.json'    => 'discourse_coin_engine/admin_stake2earn#index'
