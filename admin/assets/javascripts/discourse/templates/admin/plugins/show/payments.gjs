...
// route). Static markup only — converted from .hbs (discourse.hbs-extension
// deprecation; the forum self-updates daily, so deprecated formats are a
// scheduled breakage, not a warning).
<template>
